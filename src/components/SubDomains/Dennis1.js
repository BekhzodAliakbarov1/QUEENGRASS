    ...
    return (
        <div className={style.main}>
            <p className={style.menu}>
                ...
                <span>
					Газонокосилки для футбольных полей / хоккей / регби площадок				
                </span>
            </p>
            <h1 className={style.header}>Газонокосилки для футбольных полей / хоккей / регби площадок</h1>
